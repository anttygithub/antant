...
type AsZoneObjectInfo struct {
	...
	PrimaryKey        string    `orm:"column(primary_key);size(200)" description:"主键"`
	RefAttribute      string    `orm:"column(ref_attribute);null" description:"关联信息"`
	BasicAttribute    string    `orm:"column(basic_attribute);null" description:"基础信息"`
	AdditionAttribute string    `orm:"column(addition_attribute);null" description:"附加信息"`
